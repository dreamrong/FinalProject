...
<body style="background-color: #f5f6fa">
	...
	<div class="main">
		<h2>商品管理</h2>
		<hr>
		<h2 style="color: red;">新增資料</h2>
		<!-- 隱藏向servlet提交請求 -->
		<form id="form-insert" action="${req.contextPath}/insertProduct"
...
<!--    ---------------------------------------------------------------------------------------  -->
			<div class="col-md-3 prodPrice">
				<label for="price" class="form-label">售價</label> <input type="number" min="0"
					class="form-control" id="price" name="product_price"
...
<!--    ---------------------------------------------------------------------------------------  -->
			<div class="col-md-12 prodDescription1">
				...
				<textarea class="form-control" rows="3" name="product_info1" id="info1"
					>${requestScope.product.product_info1}</textarea>
...
<!--    ---------------------------------------------------------------------------------------  -->
			<div class="col-md-12 prodDescription2">
				...
				<textarea class="form-control" rows="3" name="product_info2" id="info2"
					>${requestScope.product.product_info2}</textarea>
				<div id="product_info2-input-error"  class="input-error">商品描述不能為空</div>	
			</div>
<!--    ---------------------------------------------------------------------------------------  -->
			<div class="col-md-3 image">
				<p>圖片</p>
				<input type="file" name="myFiles" value="上傳"> <span
